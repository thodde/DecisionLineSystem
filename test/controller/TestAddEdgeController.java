...
public class TestAddEdgeController extends TestCase {
	...
	/**
	 * shared setup environment method
	 * @author mpeltola
	 */
	...
	/**
	 * test add edge controller with everything good
	 * @author mpeltola
	 */
	...
	/**
	 * test add edge controller when not your turn
	 * @author mpeltola
	 */
	...
	/**test add edge controller with missing player Sam is gone!
	 * @author mpeltola
	 */
	...
	/**test add edge controller with bad y value
	 * @author mpeltola
	 */
